const names = [
    { number: 1, name: "Ar-Rahman", meaning: "The Beneficent", message: "Remember to always show kindness and mercy to those around you." },
    { number: 2, name: "Ar-Rahim", meaning: "The Merciful", message: "Forgive others and seek forgiveness from Allah, the most Merciful." },
    ...
    { number: 10, name: "Al-Mutakabbir", meaning: "The Supreme", message: "Acknowledge Allah’s greatness and submit to His will." },
    ...
    { number: 13, name: "Al-Musawwir", meaning: "The Fashioner", message: "Appreciate the beauty and uniqueness of Allah’s creations." },
    { number: 14, name: "Al-Ghaffar", meaning: "The Great Forgiver", message: "Seek forgiveness often and forgive others generously." },
    { number: 15, name: "Al-Qahhar", meaning: "The Subduer", message: "Remember that Allah’s power can overcome any challenge." },
    { number: 16, name: "Al-Wahhab", meaning: "The Bestower", message: "Be generous and share the blessings Allah has bestowed upon you." },
    { number: 17, name: "Ar-Razzaq", meaning: "The Provider", message: "Trust in Allah’s provision and work diligently." },
    { number: 18, name: "Al-Fattah", meaning: "The Opener", message: "Seek new opportunities and trust Allah to open the right doors." },
    ...
    { number: 21, name: "Al-Basit", meaning: "The Expander", message: "In times of ease, be thankful and generous to others." },
    { number: 22, name: "Al-Khafid", meaning: "The Abaser", message: "Stay humble, knowing that Allah can lower the proud." },
    { number: 23, name: "Ar-Rafi", meaning: "The Exalter", message: "Seek to elevate yourself through good deeds and piety." },
    { number: 24, name: "Al-Mu’izz", meaning: "The Honourer", message: "Honour others and seek honour through Allah’s grace." },
    ...
    { number: 28, name: "Al-Hakam", meaning: "The Judge", message: "Strive for justice in your actions and trust in Allah’s judgment." },
    { number: 29, name: "Al-Adl", meaning: "The Just", message: "Be fair in your dealings and seek justice for others." },
    { number: 30, name: "Al-Latif", meaning: "The Subtle One", message: "Notice the subtle blessings in your life and be grateful." },
    { number: 31, name: "Al-Khabir", meaning: "The All-Aware", message: "Be aware of your actions and their impact on others." },
    { number: 32, name: "Al-Halim", meaning: "The Forbearing", message: "Practice patience and forbearance in difficult situations." },
    ...
    { number: 36, name: "Al-Ali", meaning: "The Most High", message: "Exalt Allah in your heart and actions." },
    { number: 37, name: "Al-Kabir", meaning: "The Most Great", message: "Recognize Allah’s greatness in all aspects of life." },
    ...
    { number: 40, name: "Al-Hasib", meaning: "The Reckoner", message: "Be mindful of your actions, knowing you will be accountable." },
    ...
    { number: 47, name: "Al-Wadud", meaning: "The Loving", message: "Show love and compassion to others as Allah does." },
    { number: 48, name: "Al-Majid", meaning: "The Glorious", message: "Celebrate the glory of Allah in your thoughts and actions." },
    ...
    { number: 51, name: "Al-Haqq", meaning: "The Truth", message: "Seek truth in all matters and align with Allah’s truth." },
    { number: 52, name: "Al-Wakil", meaning: "The Trustee", message: "Place your trust in Allah in all affairs." },
    { number: 53, name: "Al-Qawiyy", meaning: "The Strong", message: "Draw strength from Allah in times of weakness." },
    ...
    { number: 61, name: "Al-Mumit", meaning: "The Creator of Death", message: "Remember the temporary nature of this life and prepare for the hereafter." },
    ...
    { number: 67, name: "Al-Ahad", meaning: "The One", message: "Recognize the oneness of Allah in all that you do." },
    { number: 68, name: "As-Samad", meaning: "The Eternal", message: "Depend on Allah’s eternal presence and support." },
    { number: 69, name: "Al-Qadir", meaning: "The Omnipotent", message: "Trust in Allah’s limitless power and capability." },
    { number: 70, name: "Al-Muqtadir", meaning: "The Powerful", message: "Draw upon Allah’s power to overcome challenges." },
    ...
    { number: 77, name: "Al-Wali", meaning: "The Patron", message: "Find solace in Allah’s guidance and protection." },
    { number: 78, name: "Al-Muta’ali", meaning: "The Self Exalted", message: "Exalt Allah above all and seek His pleasure." },
    { number: 79, name: "Al-Barr", meaning: "The Most Kind and Righteous", message: "Emulate Allah’s kindness and righteousness in your life." },
    { number: 80, name: "At-Tawwab", meaning: "The Ever-Returning", message: "Return to Allah often through repentance." },
    ...
    { number: 89, name: "Al-Mughni", meaning: "The Enricher", message: "Be grateful for Allah’s enrichment and share with others." },
    { number: 90, name: "Al-Mani’", meaning: "The Preventer", message: "Trust Allah’s wisdom in preventing certain outcomes." },
    { number: 91, name: "Ad-Darr", meaning: "The Distresser", message: "Seek refuge in Allah during times of distress." },
    { number: 92, name: "An-Nafi’", meaning: "The Propitious", message: "Seek beneficial outcomes through Allah’s guidance." },
